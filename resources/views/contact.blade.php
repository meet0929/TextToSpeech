@extends('common')
@section('title','Contact Us Today - TextToSpeech.ai')
@section('description','Have questions or need support with our text-to-speech technology? Contact TextToSpeech.ai today, and let`s discuss how we can assist you.')
@section('content')
            ...
            <div class="col-md-9 col-12">
                <div class="row justify-content-evenly">
                    <div class="col-md-6 col-12">
                        <h1> <span class="ytext-ybg p-2 px-3 f20">CONTACT US</span></h1>
                        <p class="heading2">Connect with Us: <span class="c-purple">Your Voice Matters</span></p>
                        <p>We're here to listen and eager to help. Whether you have questions, feedback, or ideas, your
                            voice is important to us. Reach out today, and let's start the conversation. Together, we
                            can shape the future of voice technology.</p>
                        <figure>
                            <svg width="167" height="26" viewBox="0 0 167 26" fill="none"
                    ...
                    <div class="col-md-6 col-12 p-3 p-md-0">
                    <form action="{{ route('contact.store') }}" method="POST">
                        @csrf
                        <div class="gradient-bg p-3 p-md-4 rounded-4">
                            <p class="heading3">Get In Touch</p>
                            <p>Please fill out the form below to start your journey with us.</p>
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" placeholder="Leave a message here" name="message" id="contactmessage"
